                                    ...
                                    <!-- CATEGORIAS DE ITEMS -->
                                        ...
                                        <div class="panel panel-info">
                                          <div class="panel-heading">
                                            <h2 class="panel-title">INSCRIPCIÓN, REINSCRIPCIÓN</h2>
                                          </div>
                                          <div class="panel-body">
                                          <!--  ITEMS -->
                                           <div class="row">
                                               <div class="col-xs-12 col-sm-9 lead col-md-9 col-md-offset-0">
                                                   1. Se dio a conocer de forma oportuna el calendario de inscripciones y reinscripciones:
                                               </div>
                                               <div class="col-xs-9 col-xs-offset-2 col-sm-3 col-md-3 col-md-offset-0 ">
                                                   <div class="box box-blue box-example-1to10 center-block">
                                                      <div class="box-body">
                                                        <select  class="selector" name="rating" autocomplete="off">
                                        ...
                                        <div class="row">
                                               <div class="col-xs-12 col-sm-9 lead col-md-9 col-md-offset-0">
                                                  2.  La carga académica cuenta con horario, aula y docente asignado: 
                                               </div>
                                               <div class="col-xs-9 col-xs-offset-2 col-sm-3 col-md-3 col-md-offset-0 ">
                                                   <div class="box box-blue box-example-1to10 center-block">
                                                      <div class="box-body">
...
<!-- CATEGORIAS DE ITEMS -->
                                        <div class="panel panel-info">
                                          <div class="panel-heading">
                                            <h2 class="panel-title">INSTALACIONES LIMPIAS Y EN BUENAS CONDICIONES</h2>
                                          </div>
                                          <div class="panel-body">
                                          <!--  ITEMS -->
                                           <div class="row">
